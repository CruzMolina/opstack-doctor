...
```sh
docker run --rm ghcr.io/cruzmolina/opstack-doctor:v0.1.9 version
docker run --rm -v "$PWD/examples/doctor.example.yaml:/config/doctor.yaml:ro" ghcr.io/cruzmolina/opstack-doctor:v0.1.9 check --config /config/doctor.yaml
```
